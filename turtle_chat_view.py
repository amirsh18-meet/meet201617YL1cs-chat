...
#WRITE YOUR NAME HERE! Amir Shahbari
...
5        To do this, you will use the turtle.onkeypress function.
        ...
        '''
        self.turtle.onkeypress("Return", self.send_button.fun)
        self.turtle.listen()
